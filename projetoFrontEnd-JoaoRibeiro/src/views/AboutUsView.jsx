			...
			<div>
				...
				<div>
					...
					<div>
						<div>
							<div>
								<h3>Amarante Experiences</h3>
								<img src='/img/myLogo.png' alt='Amarante Experiences Logo' />
							</div>
							<p>
								We are our Logo We are the freshness of the landscapes of the Marão Mountain and the history of the Aboboreira Mountain. We are the essence of our Vinho Verde We are the traditions of
								our gastronomy and conventual pastry We are the history of the St. Gonçalo Bridge The leaf in our logo is a symbol of our passion for nature, fresh air and the feeling of freedom. A
								symbol of the experience that will forever remain in your memory.
							</p>
						</div>
					</div>
				</div>
